...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public model: ModalController) {
    this.initializeApp();
  ...
  openReverse(){
    let modal = this.model.create(ReservationPage);
    modal.present();
  }
